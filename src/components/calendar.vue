        ...
        .timeNav 
            ...
            .month
                svg.svgIcon.reactive.prev(@click="reRender('prev')")
                    use(xlink:href="@/assets/img/icon/basic-icon.svg#icon-arrow-left" style="pointer-events: none;")
                ...
                svg.svgIcon.reactive.prev(@click="reRender('next')")
                    use(xlink:href="@/assets/img/icon/material-icon.svg#icon-arrow-right" style="pointer-events: none;")
        .timeCont 
            .days 
                .day Mo
                .day Tu
    ...
    .timeSettingWrap
        .input(@mouseover="startDate ? showIcon.start = true : showIcon.start = false" @mouseleave="showIcon.start = false")
            ...
            svg.svgIcon.black.delete(:class="{'show' : showIcon.start}" @click="deleteDate")
                use(xlink:href="@/assets/img/icon/basic-icon.svg#icon-x-circle")
        span ~
