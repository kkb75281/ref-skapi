	...
	.bg-dark
		...
		section.banner
			.banner-inner.bg-colorful
				...
				template(v-if="user?.user_id")
					button(type="button" data-aos="fade-up" data-aos-delay="500" @click="$router.push('/my-services')") Go to My Services
				router-link(v-else to="/signup")
					button(type="button" data-aos="fade-up" data-aos-delay="500") Get Started
</template>
